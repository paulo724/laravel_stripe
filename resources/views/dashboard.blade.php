        ...
        <div class="card h-100">
            <div class="card-header">
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item">
                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-tabs-line-card-income" aria-controls="navs-tabs-line-card-income" aria-selected="true">Contratar Plano</button>
                    </li>
                    <li class="nav-item">
            ...
            <div class="card-header d-flex align-items-center justify-content-between pb-0">
                <div class="card-title mb-0">
                    <h5 class="m-0 me-2">Informações sobre o plano</h5>
            ...
            <div class="card-body">
                ...
                <ul class="p-0 m-0">
                    ...
                    <li class="d-flex">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <h6 class="mb-0">Valor : R$ 109,99</h6>
                                <small class="text-muted">Assinatura 30 dias</small>
                            </div>
                    ...
                    <li class="d-flex">
                        ...
                        <stripe-buy-button buy-button-id="buy_btn_1N3VYTGZ2CkNUhfuJskhADS0" publishable-key="pk_test_51N3UsIGZ2CkNUhfuS3e6ql4ycSKtbmftL4rWM76LvyMXozueJalmplR4IHevULXkDGgLYSY40yZHp3XRorkRrDUe00oaVbKN62">
                        </stripe-buy-button>
                    </li>
                </ul>
            </div>
